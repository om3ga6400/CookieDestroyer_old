...
M.updateFunc = function () {
	...
	for (i = this.soilsById.length - 1; i >= 0; i--) {
...
var goodTooltip = function () {
	...
	this.tooltipHTML  = ('<div class="minigameTooltip">' +
		...
		'<div class="name">' + good.name + ' <span class="bankFromName">(' + loc("from %1", '<span style="font-variant:small-caps;">' + good.company +
...
for (i in M.goods) {
	...
	good.$row = $('<tr class="marketGoodRow" data-title>' +
		'<td class="marketGoodName"><div class="icon tinyIcon" style="' + good.iconCssStr + '"></div> ' + good.name + " (" + good.symbol + ")</td>" +
