...
Game.WinBuildingProductionAchs = function (building) {
	for (var i = building.productionAchievs.length - 1; i >= 0; i--) {
...
//#endregion Game Objects (Buildings)
	...
	if (tier === "fortune") {
		...
		properties.descFunc = function () {
			return ((Game.HasUpgrade(this.buildingTie1.unshackleUpgrade) && Game.HasUpgrade(Game.Tiers[this.tier].unshackleUpgrade)) ?
				('<div class="alignCenter">' + loc("Unshackled! <b>+%1%</b> extra production.", Math.round((this.buildingTie.id == 1 ? 0.5 : (20 - this.buildingTie.id) * 0.1) * 100)) + '</div><div class="line"></div>')
				: "") + this.ddesc;
		};
	}
...
Game.GrandmaSynergy = function (name, desc, building) {
	...
	var upgrade = new Game.Upgrade(name, desc,
		building.basePrice * Game.Tiers[2].price, [10, 9], {groups: "grandmaSynergy", require: grandmaSynergyRequireFunc});
...
Game.CookieUpgrade({name: "Dragon cookie",
	...
	icon: [10, 25], power: 5, price: 9999999999999999 * 7, require: function () { return Game.HasUpgrade("A crumbly egg") && Game.dragonLevel > 24; }}); //TODO programmatically set dragonLevel check?
...
new Game.Upgrade("Elder spice",
	...
	444444, [19, 8], {pool: "prestige", parents: ["Unholy bait"], buyFunc: function () {
		Game.maxWrinklers = this.bought ? 12 : 10;
		byId("numWrinklers").maxIn = Game.maxWrinklers;
		byId("numShinyWrinklers").maxIn = Game.maxWrinklers;
...
/* for (i = Game.UnlockAt.length - 1; i >= 0; i--) {
...
for (i = Game.UpgradesByGroup.permUpgradeSlot.length - 1; i >= 0; i--) {
...
for (i = Game.UpgradesByGroup.handmade.length - 1; i >= 0; i--) {
...
for (i = Game.UpgradesByGroup.selector.length - 1; i >= 0; i--) {
...
Game.Achievement.prototype.getTooltip = function (crate, update) {
	...
	var $div = $('<div class="crateTooltip achievementTooltip">' +
		'<div class="name">' + this.name + '</div><div class="tags">' + tags + "</div>" +
		'<div class="line"></div><div class="description">' + this.ddesc + "</div></div>");
...
Game.BankAchievement = function (name, q) {
	...
	var achieve = new Game.Achievement(name,
		...
		[Game.thresholdIcons[Game.BankAchievements.length], (Game.BankAchievements.length > 43 ? 2 : (Game.BankAchievements.length > 32 ? 1 : (Game.BankAchievements.length > 23 ? 2 : 5)))],
...
Game.CpsAchievement = function (name, q) {
	...
	var achieve = new Game.Achievement(name,
		...
		[Game.thresholdIcons[Game.CpsAchievements.length], (Game.CpsAchievements.length > 32 ? 1 : Game.CpsAchievements.length > 23 ? 2 : 5)],
...
new Game.Achievement("Rookie numbers",
	...
	[9, 33], {require: function () {
		for (var i = Game.market.goodsById.length - 1; i >= 0; i--) {
...
for (i = Game.AchievementsByGroup.handmade.length - 1; i >= 0; i--) {
...
Game.dragonLevels = [
	...
	{name: "Krumblor, cookie dragon", action: loc("Bake dragon cookie"), actionTitle: loc("Delicious!"), pic: 6,
		...
		cumuCost: function () { var cumu = 0; for (var i = Game.ObjectsById.length - 1; i >= 0; i--) { cumu += Game.ObjectsById[i].getPriceSum(0, 50); } return cumu; },
	...
	{name: "Krumblor, cookie dragon", action: loc("Train secondary aura"), actionTitle: loc("Lets you use two dragon auras simultaneously"), pic: 7,
		...
		cumuCost: function () { var cumu = 0; for (var i = Game.ObjectsById.length - 1; i >= 0; i--) { cumu += Game.ObjectsById[i].getPriceSum(0, 200); } return cumu; },
...
Game.setSeason = function (season) {
	...
	for (var i = Game.UpgradesByGroup.seasonSwitch.length - 1; i >= 0; i--) {
...
Game.updateToggleSelection = function () {
	...
	for (var i = Game.UpgradesByGroup.selector.length - 1; i >= 0; i--) {
...
var clearUpgradeSettingsFunc = function () {
	for (var i = clearUpgradeSettingsFuncList.length - 1; i >= 0; i--) {
...
$("#permUpgradesBlock").on("click", "#permUpgradeSlots .crate", function () {
	...
	if (isEnabled) {
		...
		for (var i = Game.permanentUpgrades.length - 1; i >= 0; i--) {
