AddLanguage('EN','english',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(cookies/img/money.png);width:16px;height:16px;\"></div>": "Brought to you by the letter <div style=\"display:inline-block;background:url(cookies/img/money.png);width:16px;height:16px;\"></div>",
